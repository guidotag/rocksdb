...
NUM_THREADS_LIST=(16) #(1 16 32 64 80 160 320)        # Assuming 80 CPUs and HT. Remember to enable HT.
NUM_SHARDS_LIST=(64)
CACHE_TYPE_LIST=(lru_cache) #(clock_cache lru_cache)
        ...
        do
            ...
            do
                ...
                do
                    ...
                    SUPPORT_SIZE_LIST=($LARGE_SUPPORT) #($SINGLETON $VERY_SMALL_SUPPORT $SMALL_SUPPORT $MEDIUM_SUPPORT $LARGE_SUPPORT $VERY_LARGE_SUPPORT $HUGE_SUPPORT)
